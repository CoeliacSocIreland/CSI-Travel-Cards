...
const translations = {
    ...
    el: {
        ...
        cannotEat: "Δεν μπορώ να καταναλώσω τροφές που περιέχουν γλουτένη, η οποία βρίσκεται στο σιτάρι, τη σίκαλη, το κριθάρι και τη βρώμη. Το γεύμα μου δεν πρέπει να περιέχει:",
        items: [
            "Ψωμί, τριμμένη φρυγανιά, σιμιγδάλι ή ζυμαρικά",
            "Μπισκότα, κουλουράκια, κέικ, μάφιν ή πίτες",
            "Αλεύρι, διάφορα λουκάνικα και προϊόντα ζύμης",
            "Σάλτσες, σούπες, βύνη, εκχύλισμα βύνης, ζωμούς και μπύρα"
        ],
        crossContamination: "Κίνδυνος διασταυρούμενης επιμόλυνσης",
        warning: "Ακόμη και μια μικρή ποσότητα γλουτένης μπορεί να με αρρωστήσει σοβαρά. Είναι πολύ σημαντικό το φαγητό μου να μην έρθει σε επαφή με γλουτένη ή μολυσμένες επιφάνειες.",
        safeFoods: "Ασφαλείς τροφές",
        safeItems: [
            "Κρέας, ψάρι, αυγά",
            "Φρούτα, λαχανικά, όσπρια",
            "Ρύζι, καλαμπόκι, σόγια, πατάτες",
            "Κρασί, τυρί, γάλα"
        ],
        closing: "Σας ευχαριστώ πολύ για την προετοιμασία ενός γεύματος που μπορώ να καταναλώσω με ασφάλεια!"
    }
    pt: {
        title: "Aviso Importante",
